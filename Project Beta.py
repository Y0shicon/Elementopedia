...
for i in elements_dict :
	...
	small_images[i] = ImageTk.PhotoImage(Image.open('Images/' + elements_dict[i][0] + '.png').resize((67,67), Image.ANTIALIAS))
...
def blink(i):
    ...
    elements_buttons[i].after(2000, lambda: elements_buttons[i].config(bg='white', bd = 1))
...
#Making a dictionary of buttons with elements
elements_buttons = {}
for i in elements_dict:
